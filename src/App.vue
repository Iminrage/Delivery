    ...
    <div class="wrapper">
      <main class="page-main">
        ...
        <div class="tabs-block">
          ...
          <input id="tab-pick-up" type="radio" name="tab" checked />
          <label for="tab-pick-up">
            <span>Самовывоз</span>
            <svg
              width="288"
              height="78"
          ...
          <input id="tab-delivery" type="radio" name="tab" />
          <label for="tab-delivery" class="delivery-type">
